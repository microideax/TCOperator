...
#pragma HLS INTERFACE m_axi offset = slave latency = 4 num_read_outstanding = 16 max_read_burst_length = 32 bundle = gmem2 port = column_list_1
#pragma HLS INTERFACE m_axi offset = slave latency = 4 num_read_outstanding = 16 max_read_burst_length = 32 bundle = gmem3 port = column_list_2
