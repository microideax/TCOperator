...
int main(int argc, const char* argv[]) {
    ...
    DT* offsets = aligned_alloc<DT>(E); // need to modify this, for fast host_to_device copy.
    DT* rows = aligned_alloc<DT>(V); // need to modify this, for fast host_to_device copy.
    std::cout << "allocate memory success, v = " << V << " E = "<< E << std::endl;
    // -------------setup k0 params---------------
    int nerr = 0;
    ...
    // } else {
    //     std::cout << "TC number : " << out << std::endl;
